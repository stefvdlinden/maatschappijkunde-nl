...
const checks = [
  ...
  { name: 'empty_content_wrapper', pattern: /<(?:div|section) class="(?:content-row|content-column|content-column-text|content-panel|tab-section|toggle)">\s*<\/(?:div|section)>/i, severity: 'high' },
